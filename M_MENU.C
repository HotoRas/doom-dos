...
int		sfxVolume;                      // has default 0 - 15 
int		musicVolume;                    // has default 0 - 15 
int		detailLevel;                    // has default, 0 = high, 1 = normal 
int		screenblocks;                   // has default 
int		screenSize;                     // temp for screenblocks (0-9) 
int		quickSaveSlot;          // -1 = no slot picked! 
 
int		messageToPrint;         // 1 = message to be printed 
char    *messageString;         // ...and here's the message string! 
int		messx;                                  // message x & y 
int		messy; 
...
int             saveStringEnter;                // we're going to be entering a savegame string 
...
char    skullName[2][8] =                       // graphic name of skulls 
		{"M_SKULL1","M_SKULL2"}; 
